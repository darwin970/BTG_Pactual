package com.btg.core.infraestructura.jdbc;
...
import com.btg.core.infraestructura.excepcion.ExcepcionTecnica;

@Repository
@ConditionalOnProperty(name = "spring.datasource.jdbc-url")
