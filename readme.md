...
## Advertencia de Seguridad: Este componente no ha sido actualizado y puede contener vulnerabilidades debido a la falta de actualizaciones en sus librerías. Utilícelo bajo su propio riesgo para la revisión de la estructura o actualización de versiones. Para obtener información o si desea contribuir con la actualización de este componente, contacte a swat@ceiba.com.co.
